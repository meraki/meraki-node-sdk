...
|-----------|-------------|
| xCiscoMerakiAPIKey | DevNet Demo Sandbox API Key |
...
lib.Configuration.xCiscoMerakiAPIKey = "093b24e85df15a3e66f1fc359f4c48493eaa1b73"; // DevNet Demo Sandbox API Key
...
* [IDSAlertsController](#ids_alerts_controller)
...
## <a name="ids_alerts_controller"></a>![Class: ](https://apidocs.io/img/class.png ".IDSAlertsController") IDSAlertsController

### Get singleton instance

The singleton instance of the ``` IDSAlertsController ``` class can be accessed from the API Client.

```javascript
var controller = lib.IDSAlertsController;
```

### <a name="get_ids_alerts_packet_q_ts_ids_alert_timestamp_q_organization_id_organization_id_q_network_id_network_id"></a>![Method: ](https://apidocs.io/img/method.png ".IDSAlertsController.getIdsAlertsPacketQTsIdsAlertTimestampQOrganizationIdOrganizationIdQNetworkIdNetworkId") getIdsAlertsPacketQTsIdsAlertTimestampQOrganizationIdOrganizationIdQNetworkIdNetworkId
...
> 
> ```
> curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -X GET -H 'Content-Type: application/json' 'https://n144.meraki.com/api/v0/ids_alerts/packet?q_ts=1517243994.16592&q_organization_id&q_network_id=1195612'
> 
> ```


```javascript
function getIdsAlertsPacketQTsIdsAlertTimestampQOrganizationIdOrganizationIdQNetworkIdNetworkId(input, callback)
```
#### Parameters

| Parameter | Tags | Description |
|-----------|------|-------------|
| idsAlertTimestamp |  ``` Required ```  | TODO: Add a parameter description |
| organizationId |  ``` Required ```  | TODO: Add a parameter description |
| networkId |  ``` Required ```  | TODO: Add a parameter description |
| qTs |  ``` Optional ```  | The timestamp of the original ids alert |
| qOrgId |  ``` Optional ```  | The organization id of the ids alert |
| qNetworkId |  ``` Optional ```  | The network id of the ids alert |
...
```javascript
    ...
    var input = [];
        input['idsAlertTimestamp'] = ids_alert_timestamp;
        input['organizationId'] = organization_id;
        input['networkId'] = network_id;
        input['qTs'] = q_ts;
        input['qOrgId'] = q_org_id;
        input['qNetworkId'] = q_network_id;

    controller.getIdsAlertsPacketQTsIdsAlertTimestampQOrganizationIdOrganizationIdQNetworkIdNetworkId(input, function(error, response, context) {
...
### <a name="get_ids_alerts_start_time_float_start_time_end_time_optional_float_end_time"></a>![Method: ](https://apidocs.io/img/method.png ".IDSAlertsController.getIdsAlertsStartTimeFloatStartTimeEndTimeOptionalFloatEndTime") getIdsAlertsStartTimeFloatStartTimeEndTimeOptionalFloatEndTime
...
> 
> ```
> curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -X GET -H 'Content-Type: application/json' 'https://n144.meraki.com/api/v0/ids_alerts?start_time=1474922408.474945'
> 
> ```


```javascript
function getIdsAlertsStartTimeFloatStartTimeEndTimeOptionalFloatEndTime(input, callback)
```
#### Parameters

| Parameter | Tags | Description |
|-----------|------|-------------|
| floatStartTime |  ``` Required ```  | TODO: Add a parameter description |
| optionalFloatEndTime |  ``` Required ```  | TODO: Add a parameter description |
| startTime |  ``` Optional ```  | The start time (exclusive) of the query specified as seconds since the epoch expressed as a floating-point number. |
| endTime |  ``` Optional ```  | The end time (exclusive) of the query specified as seconds since the epoch expressed as a floating-point number. This parameter is optional. |
...
```javascript
    ...
    var input = [];
        input['floatStartTime'] = float_start_time;
        input['optionalFloatEndTime'] = optional_float_end_time;
        input['startTime'] = start_time;
        input['endTime'] = end_time;

    controller.getIdsAlertsStartTimeFloatStartTimeEndTimeOptionalFloatEndTime(input, function(error, response, context) {
...
> 
> ```
> curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -H 'Content-Type: application/json' -X PUT --data-binary '{"trafficShapingEnabled":true,"defaultRulesEnabled":true,"rules":[{"definitions":[{"type":"host","value":"google.com"},{"type":"port","value":"9090"},{"type":"ipRange","value":"192.1.0.0"},{"type":"ipRange","value":"192.1.0.0/16"},{"type":"ipRange","value":"10.1.0.0/16:80"},{"type":"localNet","value":"192.168.0.0/16"},{"type":"applicationCategory","value":{"id":"meraki:layer7/category/2","name":"Blogging"}},{"type":"application","value":{"id":"meraki:layer7/application/133","name":"Battle.net"}}],"perClientBandwidthLimits":{"settings":"custom","bandwidthLimits":{"limitUp":1000000,"limitDown":1000000}},"dscpTagValue":null,"pcpTagValue":null}]}' 'https://api.meraki.com/api/v0/networks/{networkId}/ssids/{number}/trafficShaping'
> ```
...
> 
> ```
> curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -H 'Content-Type: application/json' -X GET 'https://api.meraki.com/api/v0/organizations/{organizationId}/webhookLogs'
> ```
...
> 
> ```
> curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -H 'Content-Type: application/json' -X GET 'https://api.meraki.com/api/v0/organizations/{organizationId}/securityEvents'
> ```
...
> 
> ```
> curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -H 'Content-Type: application/json' -X GET 'https://api.meraki.com/api/v0/networks/{networkId}/securityEvents'
> ```
...
> 
> ```
> curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -H 'Content-Type: application/json' -X PUT --data-binary '{"mode":"prevention","idsRulesets":"balanced","protectedNetworks":{"useDefault":false,"includedCidr":["10.0.0.0/8","127.0.0.0/8","169.254.0.0/16","172.16.0.0/12"],"excludedCidr":["10.0.0.0/8","127.0.0.0/8"]}}' 'https://api.meraki.com/api/v0/networks/[networkId]/security/intrusionSettings'
> ```
...
> 
> ```
> curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -H 'Content-Type: application/json' -X GET 'https://api.meraki.com/api/v0/organizations/[organizationId]/security/intrusionSettings'
> ```
...
> 
> ```
> curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -H 'Content-Type: application/json' -X GET 'https://api.meraki.com/api/v0/networks/[networkId]/security/intrusionSettings'
> ```
...
> 
> ```
> curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -H 'Content-Type: application/json' -X GET 'https://api.meraki.com/api/v0/networks/{networkId}/wireless/rfProfiles'
> ```
...
> 
> ```
> curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -H 'Content-Type: application/json' -X PUT --data-binary '{"mode":"enabled"}' 'https://api.meraki.com/api/v0/networks/[networkId]/security/malwareSettings'
> ```
...
### <a name="update_organization_config_template"></a>![Method: ](https://apidocs.io/img/method.png ".ConfigTemplatesController.updateOrganizationConfigTemplate") updateOrganizationConfigTemplate
...
> 
> ```
> curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -H 'Content-Type: application/json' -X PUT 'https://api.meraki.com/api/v0/organizations/[organizationId]/configTemplates/[id]'
> ```


```javascript
function updateOrganizationConfigTemplate(input, callback)
```
#### Parameters
...
```javascript
    ...
    var input = [];
        input['organizationId'] = 'organizationId';
        input['id'] = 'id';
        input['updateOrganizationConfigTemplate'] = new UpdateOrganizationConfigTemplateModel({"key":"value"});

    controller.updateOrganizationConfigTemplate(input, function(error, response, context) {
