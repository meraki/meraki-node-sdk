...
class APIUsageController {
     ...
     * or equal to 31 days. The default is 31 days.
     ...
     * the first, last, prev, or next page in the HTTP Link
     * header should define it.
     * @param {string} input['adminId'] (optional) Filter the results by the ID of the admin who
     * made the API requests
     * @param {string} input['path'] (optional) Filter the results by the path of the API requests
     * @param {string} input['method'] (optional) Filter the results by the method of the API
     * requests (must be 'GET', 'PUT', 'POST' or 'DELETE')
     * @param {int} input['responseCode'] (optional) Filter the results by the response code of the
     * API requests
     * @param {string} input['sourceIp'] (optional) Filter the results by the IP address of the
     ...
     * @returns {Promise}
     */
    static getOrganizationApiRequests(input, callback) {
     ...
     * @returns {Promise}
     */
    static getOrganizationApiRequestsOverview(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
