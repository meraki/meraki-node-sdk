...
class SsidsController {
     ...
     * @returns {Promise}
     */
    static createResetNetworkSsid(input, callback) {
     ...
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['number'] TODO: type description here
     * @param {UpdateNetworkSsidModel} input['updateNetworkSsid'] (optional) TODO: type description
     * here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateNetworkSsid(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkSsid),
        };
     ...
     * @returns {Promise}
     */
    static getNetworkSsid(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
