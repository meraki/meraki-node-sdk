...
class MXInboundFirewallController {
    /**
     ...
     * @param {UpdateNetworkApplianceFirewallInboundFirewallRulesModel} input['updateNetworkApplianceFirewallInboundFirewallRules'] (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateNetworkApplianceFirewallInboundFirewallRules(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkApplianceFirewallInboundFirewallRules),
        };
...
module.exports = MXInboundFirewallController;
