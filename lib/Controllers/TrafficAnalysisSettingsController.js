...
class TrafficAnalysisSettingsController {
     ...
     * @returns {Promise}
     */
    static getNetworkTrafficAnalysisSettings(networkId, callback) {
        ...
        let _pathUrl = '/networks/{networkId}/trafficAnalysisSettings';
     ...
     * @param {UpdateNetworkTrafficAnalysisSettingsModel} input['updateNetworkTrafficAnalysisSettings'] (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateNetworkTrafficAnalysisSettings(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkTrafficAnalysisSettings),
        };
...
module.exports = TrafficAnalysisSettingsController;
