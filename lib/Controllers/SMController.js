...
class SMController {
     ...
     * @returns {Promise}
     */
    static refreshNetworkSmDeviceDetails(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        let _pathUrl = '/networks/{networkId}/sm/device/{deviceId}/refreshDetails';
        // process template parameters
        _pathUrl = _apiHelper.appendUrlWithTemplateParameters(_pathUrl, {
            networkId: input.networkId,
     ...
     * @param {int} input['batchSize'] (optional) Number of devices to return, 1000 is the default
     * as well as the max.
     * @param {string} input['batchToken'] (optional) If the network has more devices than the
     * batch size, a batch token will be returned     as a part
     * of the device list. To see the remainder of the devices,
     * pass in the batchToken as a parameter in the next
     * request.     Requests made with the batchToken do not
     * require additional parameters as the batchToken includes
     * the parameters passed in     with the original request.
     * Additional parameters passed in with the batchToken will
     * be ignored.
     *
     * @callback    The callback function that returns response from the API call
     *
