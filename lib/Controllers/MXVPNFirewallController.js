...
class MXVPNFirewallController {
     ...
     * @param {UpdateOrganizationVpnFirewallRulesModel} input['updateOrganizationVpnFirewallRules'] (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateOrganizationVpnFirewallRules(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateOrganizationVpnFirewallRules),
        };
