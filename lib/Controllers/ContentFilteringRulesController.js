...
class ContentFilteringRulesController {
     ...
     * @param {UpdateNetworkContentFilteringModel} input['updateNetworkContentFiltering'] (optional
     * ) TODO:
     * type
     * descripti
     * on here
     ...
     * @returns {Promise}
     */
    static updateNetworkContentFiltering(input, callback) {
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkContentFiltering),
        };
