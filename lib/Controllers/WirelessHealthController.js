...
class WirelessHealthController {
     ...
     * @param {string} input['t0'] (optional) Start of the requested time range in seconds since
     * epoch (Required)
     * @param {string} input['t1'] (optional) End of the requested time range in seconds since
     * epoch (Required)
     * @param {string} input['ssid'] (optional) Filter results by SSID
     * @param {string} input['vlan'] (optional) Filter results by VLAN
     ...
     * @param {string} input['clientId'] (optional) Filter by client
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
