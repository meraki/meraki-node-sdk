...
class DevicesController {
     ...
     * @param {CycleDeviceSwitchPortsModel} input['cycleDeviceSwitchPorts'] TODO: type description
     * here
     *
     ...
     * @returns {Promise}
     */
    static cycleDeviceSwitchPorts(input, callback) {
        ...
        } else if (input.cycleDeviceSwitchPorts === null || input.cycleDeviceSwitchPorts === undefined) {
            const _err = { errorMessage: 'The property `cycleDeviceSwitchPorts` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.cycleDeviceSwitchPorts),
        };
     ...
     * @param {ClaimNetworkDevicesModel} input['claimNetworkDevices'] (optional) TODO: type
     * description here
     *
     * @callback    The callback function that returns response from the API call
     *
     ...
     * or equal to 31 days. The default is 1 day.
     ...
     * the first, last, prev, or next page in the HTTP Link
     * header should define it.
     * @param {string} input['configurationUpdatedAfter'] (optional) Filter results by whether or
     * not the device's configuration has been
    ...
    static getOrganizationDevices(input, callback) {
        ...
        _queryBuilder = _apiHelper.appendUrlWithQueryParameters(_queryBuilder, {
            ...
            configurationUpdatedAfter: input.configurationUpdatedAfter,
        });
