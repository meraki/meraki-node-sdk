...
class DevicesController {
     ...
     * @param {BlinkLedsNetworkDeviceModel} blinkLedsNetworkDevice (optional) TODO: type
     * description here
     *
     ...
     * @returns {Promise}
     */
    static createBlinkLedsNetworkDevice(networkId, serial, blinkLedsNetworkDevice, callback) {
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(blinkLedsNetworkDevice),
        };
     ...
     * @param {string} networkId TODO: type description here
     * @param {string} serial TODO: type description here
     * @param {UpdateNetworkDeviceModel} updateNetworkDevice (optional) TODO: type description
     * here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateNetworkDevice(networkId, serial, updateNetworkDevice, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(updateNetworkDevice),
        };
     ...
     * @returns {Promise}
     */
    static createRebootNetworkDevice(networkId, serial, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     *
     * @param {string} networkId TODO: type description here
     * @param {ClaimNetworkDevicesModel} claimNetworkDevices TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createClaimNetworkDevices(networkId, claimNetworkDevices, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * uplinks are wan1, wan2, cellular. The default is wan1.
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
