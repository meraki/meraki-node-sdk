...
class DevicesController {
     ...
     * data-binary '{"duration":20,"period":160,"duty":50}' 'https://api.meraki.
     * com/api/v0/networks/{networkId}/devices/{serial}/blinkLeds'
     * ```
     *
     * @param  {array}  input    Array with all options for search
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['serial'] TODO: type description here
     * @param {BlinkLedsNetworkDeviceModel} input['blinkLedsNetworkDevice'] (optional) TODO: type
     * description here
     *
     ...
     * @returns {Promise}
     */
    static createBlinkLedsNetworkDevice(input, callback) {
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.blinkLedsNetworkDevice),
        };
     ...
     * ```
     * curl -L -H 'X-Cisco-Meraki-API-Key: <key>' -H 'Content-Type: application/json' -X POST
     * 'https://api.meraki.com/api/v0/networks/{networkId}/devices/{serial}/reboot'
     * ```
     *
     * @param  {array}  input    Array with all options for search
     * @param {string} input['networkId'] TODO: type description here
     ...
     * @returns {Promise}
     */
    static createRebootNetworkDevice(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static createRemoveNetworkDevice(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static createClaimNetworkDevices(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
