...
class MXL3FirewallController {
     ...
     * @param {UpdateNetworkL3FirewallRulesModel} input['updateNetworkL3FirewallRules'] (optional)
     * TODO: type
     * description
     * here
     *
     ...
     * @returns {Promise}
     */
    static updateNetworkL3FirewallRules(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkL3FirewallRules),
        };
