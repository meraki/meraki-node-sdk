...
class AlertSettingsController {
     ...
     * @param {UpdateNetworkAlertSettingsModel} input['updateNetworkAlertSettings'] (optional) TODO:
     * type
     * description
     * here
     *
     ...
     * @returns {Promise}
     */
    static updateNetworkAlertSettings(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkAlertSettings),
        };
