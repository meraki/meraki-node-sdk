...
class PhoneAnnouncementsController {
     ...
     * @param {CreateNetworkPhoneAnnouncementsModel} input['createNetworkPhoneAnnouncements'] (opti
     * onal)
     * TODO:
     * type
     * descr
     ...
     * @returns {Promise}
     */
    static createNetworkPhoneAnnouncements(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.createNetworkPhoneAnnouncements),
        };
     ...
     * @returns {Promise}
     */
    static deleteNetworkPhoneAnnouncement(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
