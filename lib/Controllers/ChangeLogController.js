...
class ChangeLogController {
     ...
     * the first, last, prev, or next page in the HTTP Link
     * header should define it.
     * @param {string} input['networkId'] (optional) Filters on the given network
     * @param {string} input['adminId'] (optional) Filters on the given Admin
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static getOrganizationConfigurationChanges(input, callback) {
