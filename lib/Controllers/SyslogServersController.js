...
class SyslogServersController {
     ...
     * @param {UpdateNetworkSyslogServersModel} input['updateNetworkSyslogServers'] (optional) TODO:
     * type
     * description
     * here
     *
     ...
     * @returns {Promise}
     */
    static updateNetworkSyslogServers(input, callback) {
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkSyslogServers),
        };
