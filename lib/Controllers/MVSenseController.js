...
class MVSenseController {
     ...
     * or equal to 7 days. The default is 1 hour.
     * @param {ObjectTypeEnum} input['objectType'] (optional) [optional] The object type for which
     * analytics will be retrieved. The default object
     * type is person. The available types are [person,
     * vehicle].
     *
     * @callback    The callback function that returns response from the API call
     *
    ...
    static getDeviceCameraAnalyticsOverview(input, callback) {
        ...
        _queryBuilder = _apiHelper.appendUrlWithQueryParameters(_queryBuilder, {
            ...
            objectType: (input.objectType !== null) ? input.objectType : null,
        });
     ...
     * @returns {Promise}
     */
    static getDeviceCameraAnalyticsRecent(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * fetched. If specifying timespan, do not specify parameters
     * t0 and t1. The value must be in seconds and be less than
     * or equal to 14 hours. The default is 1 hour.
