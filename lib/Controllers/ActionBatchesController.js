...
class ActionBatchesController {
     ...
     * @param {CreateOrganizationActionBatchModel} input['createOrganizationActionBatch'] TODO:
     * type
     * descripti
     * on here
     *
    ...
    static createOrganizationActionBatch(input, callback) {
        ...
        } else if (input.createOrganizationActionBatch === null || input.createOrganizationActionBatch === undefined) {
            const _err = { errorMessage: 'The property `createOrganizationActionBatch` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['organizationId'] TODO: type description here
     * @param {string} input['actionBatchId'] TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
    ...
    static getOrganizationActionBatch(input, callback) {
        ...
        if (input.organizationId === null || input.organizationId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.actionBatchId === null || input.actionBatchId === undefined) {
            const _err = { errorMessage: 'The property `actionBatchId` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
