...
class ActionBatchesController {
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['organizationId'] TODO: type description here
     * @param {CreateOrganizationActionBatchesModel} input['createOrganizationActionBatches'] (opti
     * onal)
     * TODO:
     * type
     * descr
     ...
     * @returns {Promise}
     */
    static createOrganizationActionBatches(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.createOrganizationActionBatches),
        };
