...
class WirelessSettingsController {
     ...
     * @param {UpdateNetworkWirelessSettingsModel} input['updateNetworkWirelessSettings'] (optional
     * ) TODO:
     * type
     * descripti
     * on here
     ...
     * @returns {Promise}
     */
    static updateNetworkWirelessSettings(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkWirelessSettings),
        };
...
module.exports = WirelessSettingsController;
