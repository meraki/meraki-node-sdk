...
class VlansController {
    ...
    static createNetwork_vlans(input, callback) {
        ...
        if (input.networkId === null || input.networkId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.createNetwork_vlans === null || input.createNetwork_vlans === undefined) {
            const _err = { errorMessage: 'The property `createNetwork_vlans` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
