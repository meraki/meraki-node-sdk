...
class ClientsController {
     ...
     * @param {double} input['timespan'] (optional) The timespan for which the information will be
     * fetched. If specifying timespan, do not specify parameter
     * t0. The value must be in seconds and be less than or equal
     * to 31 days. The default is 1 day.
     *
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['networkId'] TODO: type description here
     * @param {ProvisionNetworkClientsModel} input['provisionNetworkClients'] TODO: type
     * description here
     *
     * @callback    The callback function that returns response from the API call
     *
    ...
    static provisionNetworkClients(input, callback) {
        ...
        if (input.networkId === null || input.networkId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.provisionNetworkClients === null || input.provisionNetworkClients === undefined) {
            const _err = { errorMessage: 'The property `provisionNetworkClients` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
     ...
     * @param {double} input['timespan'] (optional) The timespan for which the information will be
     * fetched. If specifying timespan, do not specify parameters
     * t0 and t1. The value must be in seconds and be less than
     * or equal to 791 days. The default is 1 day.
     ...
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['clientId'] TODO: type description here
     * @param {UpdateNetworkClientPolicyModel} input['updateNetworkClientPolicy'] TODO: type
     * description here
     *
     * @callback    The callback function that returns response from the API call
     *
    ...
    static updateNetworkClientPolicy(input, callback) {
        ...
        if (input.networkId === null || input.networkId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.updateNetworkClientPolicy === null || input.updateNetworkClientPolicy === undefined) {
            const _err = { errorMessage: 'The property `updateNetworkClientPolicy` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
     ...
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['clientId'] TODO: type description here
     * @param {UpdateNetworkClientSplashAuthorizationStatusModel} input['updateNetworkClientSplashAuthorizationStatus'] TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
    ...
    static updateNetworkClientSplashAuthorizationStatus(input, callback) {
        ...
        if (input.networkId === null || input.networkId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.updateNetworkClientSplashAuthorizationStatus === null || input.updateNetworkClientSplashAuthorizationStatus === undefined) {
            const _err = { errorMessage: 'The property `updateNetworkClientSplashAuthorizationStatus` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
