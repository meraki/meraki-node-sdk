...
class NetFlowSettingsController {
     ...
     * @param {UpdateNetworkNetflowSettingsModel} input['updateNetworkNetflowSettings'] (optional)
     * TODO: type
     * description
     * here
     *
     ...
     * @returns {Promise}
     */
    static updateNetworkNetflowSettings(input, callback) {
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkNetflowSettings),
        };
     ...
     * @returns {Promise}
     */
    static getNetworkNetflowSettings(networkId, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
