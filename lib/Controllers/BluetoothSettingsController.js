...
class BluetoothSettingsController {
    /**
     ...
     * @param {UpdateDeviceWirelessBluetoothSettingsModel} input['updateDeviceWirelessBluetoothSettings'] (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateDeviceWirelessBluetoothSettings(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateDeviceWirelessBluetoothSettings),
        };
...
module.exports = BluetoothSettingsController;
