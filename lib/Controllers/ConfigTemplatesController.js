...
class ConfigTemplatesController {
     ...
     * @param {UpdateOrganizationConfigTemplateModel} input['updateOrganizationConfigTemplate'] (op
     * tio
     * nal
     * )
     * TOD
     ...
     * @returns {Promise}
     */
    static updateOrganizationConfigTemplate(input, callback) {
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateOrganizationConfigTemplate),
        };
