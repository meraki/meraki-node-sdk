...
class GeofencesController {
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['networkId'] TODO: type description here
     * @param {CreateNetworkSmGeofencesModel} input['createNetworkSmGeofences'] (optional) TODO:
     * type description
     * here
     *
     * @callback    The callback function that returns response from the API call
     ...
     * @returns {Promise}
     */
    static createNetworkSmGeofences(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.createNetworkSmGeofences),
        };
