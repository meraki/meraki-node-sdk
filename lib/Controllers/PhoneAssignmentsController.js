...
class PhoneAssignmentsController {
     ...
     * @returns {Promise}
     */
    static getNetworkPhoneAssignment(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['serial'] TODO: type description here
     * @param {UpdateNetworkPhoneAssignmentModel} input['updateNetworkPhoneAssignment'] (optional)
     * TODO: type
     * description
     * here
     *
     ...
     * @returns {Promise}
     */
    static updateNetworkPhoneAssignment(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkPhoneAssignment),
        };
     ...
     * @returns {Promise}
     */
    static deleteNetworkPhoneAssignment(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
