...
class NetflowSettingsController {
     ...
     * @returns {Promise}
     */
    static getNetwork_netflow_Settings(networkId, callback) {
        ...
        let _pathUrl = '/networks/{networkId}/netflowSettings';
     ...
     * @param {UpdateNetworkNetflowSettingsModel} input['updateNetwork_netflow_Settings'] (optional
     * ) TODO:
     * type
     * descripti
     * on here
     ...
     * @returns {Promise}
     */
    static updateNetwork_netflow_Settings(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetwork_netflow_Settings),
        };
...
module.exports = NetflowSettingsController;
