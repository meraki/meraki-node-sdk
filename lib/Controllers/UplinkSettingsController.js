...
class UplinkSettingsController {
     ...
     * @param {UpdateNetworkUplinkSettingsModel} input['updateNetworkUplinkSettings'] (optional)
     * TODO: type
     * description
     * here
     *
     ...
     * @returns {Promise}
     */
    static updateNetworkUplinkSettings(input, callback) {
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkUplinkSettings),
        };
