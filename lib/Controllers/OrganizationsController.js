...
class OrganizationsController {
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['organizationId'] TODO: type description here
     * @param {bool} input['includeLicenseInfo'] (optional) When this parameter is true, each
     * entity in the response will include the license
     * expiration date of the device (if any). Only
     ...
     * @returns {Promise}
     */
    static getOrganizationInventory(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        _queryBuilder = _apiHelper.appendUrlWithQueryParameters(_queryBuilder, {
            includeLicenseInfo: input.includeLicenseInfo,
        });
     ...
     * or equal to 5 minutes. The default is 5 minutes.
