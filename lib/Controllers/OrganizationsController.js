...
class OrganizationsController {
     ...
     * are wan1, wan2, cellular. Default will return all uplinks.
     ...
     * @param {UpdateOrganizationThirdPartyVPNPeersModel} updateOrganizationThirdPartyVPNPeers (opt
     * iona
     * l)
     * TODO:
     * 
     ...
     * @returns {Promise}
     */
    static updateOrganizationThirdPartyVPNPeers(id,
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(updateOrganizationThirdPartyVPNPeers),
        };
     ...
     *
     * @param {string} organizationId TODO: type description here
     * @param {ClaimOrganizationModel} claimOrganization (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createClaimOrganization(organizationId, claimOrganization, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'POST',
            headers: _headers,
            body: _apiHelper.jsonSerialize(claimOrganization),
        };
     ...
     *
     * @param {string} id TODO: type description here
     * @param {UpdateOrganizationSnmpModel} updateOrganizationSnmp (optional) TODO: type
     * description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateOrganizationSnmp(id, updateOrganizationSnmp, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     *
     * @param {string} id TODO: type description here
     * @param {CloneOrganizationModel} cloneOrganization (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createCloneOrganization(id, cloneOrganization, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     *
     * @param {string} id TODO: type description here
     * @param {UpdateOrganizationModel} updateOrganization (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateOrganization(id, updateOrganization, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
