...
class SplashSettingsController {
     ...
     * @returns {Promise}
     */
    static getNetworkSsidSplashSettings(input, callback) {
     ...
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['number'] TODO: type description here
     * @param {UpdateNetworkSsidSplashSettingsModel} input['updateNetworkSsidSplashSettings'] (opti
     * onal)
     * TODO:
     * type
     * descr
     ...
     * @returns {Promise}
     */
    static updateNetworkSsidSplashSettings(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
        ...
        const _options = {
            ...
            method: 'PUT',
            headers: _headers,
            body: _apiHelper.jsonSerialize(input.updateNetworkSsidSplashSettings),
        };
