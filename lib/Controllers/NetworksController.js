...
class NetworksController {
     ...
     * to 31 days. The default is 7 days.
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['networkId'] TODO: type description here
     * @param {UpdateNetworkSiteToSiteVpnModel} input['updateNetworkSiteToSiteVpn'] TODO: type
     * description
     * here
     *
     * @callback    The callback function that returns response from the API call
    ...
    static updateNetworkSiteToSiteVpn(input, callback) {
        ...
        if (input.networkId === null || input.networkId === undefined) {
            ...
            _callback(_err, null, null);
            return Promise.reject(_err);
        } else if (input.updateNetworkSiteToSiteVpn === null || input.updateNetworkSiteToSiteVpn === undefined) {
            const _err = { errorMessage: 'The property `updateNetworkSiteToSiteVpn` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
     ...
     * @param {string} input['networkId'] TODO: type description here
     * @param {string} input['t0'] (optional) The beginning of the timespan for the data. The
     * maximum lookback period is 30 days from today.
     * @param {double} input['timespan'] (optional) The timespan for which the information will be
     * fetched. If specifying timespan, do not specify parameter
     * t0. The value must be in seconds and be less than or equal
     * to 30 days.
