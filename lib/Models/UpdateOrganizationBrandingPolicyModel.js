...
/**
 * Creates an instance of UpdateOrganizationBrandingPolicyModel
 */
class UpdateOrganizationBrandingPolicyModel extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'helpSettings', realName: 'helpSettings', type: 'HelpSettings1Model' },
        ]);
    }
...
module.exports = UpdateOrganizationBrandingPolicyModel;
