...
/**
 * Creates an instance of CreateNetworkFloorPlanModel
 */
class CreateNetworkFloorPlanModel extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'center', realName: 'center', type: 'CenterModel' },
            {
...
module.exports = CreateNetworkFloorPlanModel;
