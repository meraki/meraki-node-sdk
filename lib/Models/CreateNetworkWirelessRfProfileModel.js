...
/**
 * Creates an instance of CreateNetworkWirelessRfProfileModel
 */
class CreateNetworkWirelessRfProfileModel extends BaseModel {
    /**
     * @constructor
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'apBandSettings', realName: 'apBandSettings', type: 'ApBandSettingsModel' },
            {
                name: 'twoFourGhzSettings',
                realName: 'twoFourGhzSettings',
                type: 'TwoFourGhzSettingsModel',
            },
            { name: 'fiveGhzSettings', realName: 'fiveGhzSettings', type: 'FiveGhzSettingsModel' },
        ]);
    }
...
module.exports = CreateNetworkWirelessRfProfileModel;
